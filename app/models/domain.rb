...
class Domain < ApplicationRecord
  ...
  validates :name, presence: true, format: { with: /\A[a-z0-9-]{1,63}(\.[a-z0-9-]{1,63})*\z/ }, uniqueness: { case_sensitive: false, scope: [:owner_type, :owner_id], message: "is already added" }
