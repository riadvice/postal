...
module SMTPClient
  class Server
    ...
    # @param credentials [SMTPClient::Credentials, nil] credentials to authenticate with, if any
    def initialize(hostname, port: 25, ssl_mode: SSLModes::AUTO, credentials: nil)
      @hostname = hostname
      @port = port
      @ssl_mode = ssl_mode
